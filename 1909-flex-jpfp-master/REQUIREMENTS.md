...
- [ ] Only the administrator should be able to take any WRITE actions on the site.
- [ ] Create a login page with a form for logging in.
- [ ] Create a user model and seed an administrator.
- [ ] Disable anyones ability to perform write actions unless logged in.
- [ ] Persist login using a cookie.
